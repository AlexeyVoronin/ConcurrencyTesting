...
namespace Tests
{
  ...
  public class ScenarioTesterTests
  {
    ...
    //TODO: Вместо IThreadUnsafeResource использовать класс для нотификации о любых обращениях к ресурсу,
    //а не только к конкретному.

    //TODO: Написать тестовый метод на случай отсутствия разблокировки после блокировки.

    //TODO: Написать тестовый метод на случай двойного захвата ресурса.
